...
func main() {
	...
	// Then create the service to be used which uses the interface (duck typing so since the above implements all functions of interface it IS A UserRepository)
